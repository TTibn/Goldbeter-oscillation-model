## Topic 3.2 - Different versions of the Goldbeter system, for different values of the parameters n 
...
global Kd;
global n;
# Case 1 - Repeated runs for initial values  m(0)=0.1,p0(0)=0.25,p1(0)=0.25,p2(0)=0.25,pn(0)=0.25 kai 3 diaforetika n=3,2,1
# Case 1.1 - Parameter n=1
...
## Graph of the values of P protein (p0,p1,p2,pn,pt)concentrations as a function of time with different values for the under-study case 2
figure (9);
PLOT1=plot(t,p(:,2),'b','linewidth',4);
hold on;
PLOT2=plot(t,p(:,3),'r','linewidth',4);
...
# Case 2 - Repeated runs for initial values m(0)=1.9,p0(0)=0.8,p1(0)=0.8,p2(0)=0.8,pn(0)=0.8 kai 3 diaforetika n=3,2,1
...
##  Graph Representation of PHASE SPACE of values m, p
figure (4);
plot(p(:,1),pt);
xlabel("mRNA(m)");
ylabel("PER protein (pt)");
